...
import AvatarGroup from "../../components/display/AvatarGroup.jsx";
...
const ViewTaskDetails = () => {
  ...
  const updateTodoChecklist = async (index) => {
    ...
    if (todoChecklist && todoChecklist[index]){
      ...
      try {
        const response = await axiosInstance.put(API_PATHS.TASKS.UPDATE_TODO_CHECKLIST(id), {todoChecklist});
